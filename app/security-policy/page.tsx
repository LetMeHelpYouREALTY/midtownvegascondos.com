...
export default function SecurityPolicyPage() {
  return (
    <>
      <Navbar />
      <PageHero
        imageKey="securityPolicy"
        leadSectionKey="securityCommitment"
        leadSectionHeading="Our Commitment to Security"
        pagePath="/security-policy"
        title="Security Policy"
        subtitle={`Responsible disclosure for ${siteConfig.url.replace("https://", "")} — ${officeInfo.name}.`}
        compact
      />
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                provides information for security researchers.
              </p>
            </section>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-6">
                ...
                <ul className="space-y-2 text-blue-800">
                  <li>
                    <strong>Email:</strong>{" "}
                    <a
                      href="mailto:DrDuffySells@MidtownVegasCondos.com"
                      className="underline"
                    >
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                <li>
                  ...
                  <strong>midtownvegascondos.com</strong>
                </li>
            ...
            <p className="border-t pt-6 mt-12 text-sm text-gray-500">
              Last updated: February 14, 2026. This policy is reviewed
              regularly.
            </p>
          </div>
        </div>

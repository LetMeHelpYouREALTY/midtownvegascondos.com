...
export default function ListingsPage() {
  return (
    <>
      ...
      >
        <p className="text-xl md:text-2xl text-white/85 mb-8 max-w-3xl mx-auto">Search thousands of Las Vegas, Henderson, and Summerlin properties with live MLS 
              listings updated every 15 minutes. Find your dream home with expert guidance from 
              Dr. Jan Duffy at <strong>Berkshire Hathaway HomeServices</strong>.</p>

...
export const metadata: Metadata = withPageHeroMetadata("/home-valuation", {
  ...
  description:
    "Get a free, accurate home valuation in Las Vegas from Dr. Jan Duffy at Berkshire Hathaway HomeServices. Expert CMA analysis for Summerlin, Henderson, Green Valley & all Las Vegas neighborhoods. Call (702) 500-1980.",
  keywords: [
...
export default function HomeValuationPage() {
  return (
    <>
      ...
      >
        <p className="text-xl md:text-2xl text-white/85 mb-8 max-w-3xl mx-auto">Get a free, no-obligation home valuation from Dr. Jan Duffy at{" "}
              <strong>Berkshire Hathaway HomeServices</strong>. Accurate pricing backed by 17+ years
              of Las Vegas market expertise and $127M+ in closed transactions.</p>
      </PageHero>

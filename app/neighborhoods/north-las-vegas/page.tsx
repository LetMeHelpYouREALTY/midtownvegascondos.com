  ...
  return (
    <>
      ...
      <PageHero
        ...
        leadSectionKey="northLasVegasWhy"
        leadSectionHeading="North Las Vegas: The Valley's Best Value for First-Time Buyers"
      ...
      >
        <p className="text-xl md:text-2xl text-white/85 mb-8 max-w-3xl mx-auto">
          Affordable homeownership and investment opportunities. Find your North
          Las Vegas home with <strong>Berkshire Hathaway HomeServices</strong>{" "}
          and Dr. Jan Duffy.
        </p>
      </PageHero>
        ...
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            ...
            <SectionPhoto
              ...
              heading="Frequently Asked Questions About North Las Vegas"
              className="mx-auto mb-8 max-w-4xl text-left"
            />

...
export const metadata: Metadata = withPageHeroMetadata(
  ...
  {
    title:
      "Berkshire Hathaway HomeServices Green Valley | Henderson Real Estate",
    description:
      "Find Green Valley homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in Henderson's Green Valley parks and trail-connected streets. Median price $520K. Call (702) 500-1980.",
    keywords: [
  ...
  return (
    <>
      ...
      <PageHero
        ...
        leadSectionKey="greenValleyWhy"
        leadSectionHeading="Green Valley: 35+ Years of Henderson Homes"
      ...
      >
        <p className="text-xl md:text-2xl text-white/85 mb-8 max-w-3xl mx-auto">
          Henderson's original master-planned community. Find your Green Valley

...
export const metadata: Metadata = withPageHeroMetadata(
  "/neighborhoods/henderson",
  {
    ...
    description:
      "Find Henderson homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in Henderson's master-planned communities. Median price $485K. Call (702) 500-1980.",
    keywords: [
...
const neighborhoodSchema = {
  ...
  description:
    "Nevada's second-largest city with parks, trail systems, and master-planned villages",
  geo: {
    "@type": "GeoCoordinates",
    latitude: "36.0395",
    longitude: "-114.9817",
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "How far is Henderson from midtown Las Vegas?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Henderson is Nevada's second-largest city, about 16 miles from the Arts District office. Buyers compare Green Valley, Anthem, and Inspirada on HOA amenities, commute times, and price per square foot.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Henderson's top neighborhoods include Green Valley (mature landscaping), Inspirada (resort-style amenities), MacDonald Highlands (luxury), Anthem (golf and rec centers), and Lake Las Vegas (waterfront living). Each offers distinct HOA amenities and price bands.",
      },
    },
    {
      "@type": "Question",
  ...
  return (
    <>
      ...
      <PageHero
        ...
        leadSectionKey="hendersonWhy"
        leadSectionHeading="Why Henderson Is Nevada's Best-Kept Secret"
      ...
      >
        <p className="text-xl md:text-2xl text-white/85 mb-8 max-w-3xl mx-auto">
          Master-planned Henderson living. Find your Henderson home with Dr. Jan
          Duffy, your trusted <strong>Berkshire Hathaway HomeServices</strong>{" "}
        ...
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <div className="prose prose-lg max-w-none text-slate-700">
              ...
              <p>
                What sets Henderson apart? Parks, trail systems, and
                master-planned villages about 16 miles from the Arts District
                office. Compare Green Valley, Anthem, and Inspirada on HOA
                amenities, commute times, and price per square foot. Add in the
                fact that Nevada has no state income tax, and you understand why
              ...
              <div className="grid md:grid-cols-2 gap-8 not-prose">
                <div className="bg-slate-50 p-6 rounded-xl">
                  ...
                  <p className="text-slate-600">
                    Henderson includes miles of trails, neighborhood parks, and
                    rec centers across Green Valley, Anthem, and Inspirada.
                    Compare commute times to the Strip and downtown when you
                    tour.
                  </p>
                </div>
                <div className="bg-slate-50 p-6 rounded-xl">
                  ...
                  <p className="text-slate-600">
                    ...
                    centers, and a city library system. Community events
                    throughout the year—from the Henderson Farmers Market to the
                    annual Heritage Parade—run on a published calendar.
                  </p>
                </div>
              </div>
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                <h3 className="font-bold text-slate-900 mb-2">
                  How far is Henderson from midtown Las Vegas?
                </h3>
                <p className="text-slate-600">
                  Henderson is about 16 miles from the Arts District office.
                  Buyers compare Green Valley, Anthem, and Inspirada on HOA
                  amenities, commute times, and price per square foot.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                <h3 className="font-bold text-slate-900 mb-2">
                ...
                <p className="text-slate-600">
                  ...
                  amenities), MacDonald Highlands (luxury), Anthem (golf and rec
                  centers), and Lake Las Vegas (waterfront living). Each offers

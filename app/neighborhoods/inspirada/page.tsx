...
export const metadata: Metadata = withPageHeroMetadata("/neighborhoods/inspirada", {
...
export default function InspiradaPage() {
  return (
    <>
      ...
      >
        <p className="text-xl md:text-2xl text-white/85 mb-8 max-w-3xl mx-auto">Resort-style living in Henderson. Discover Inspirada with{" "}

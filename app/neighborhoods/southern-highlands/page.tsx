...
export default function SouthernHighlandsPage() {
  return (
    <>
      ...
      >
        <p className="text-xl md:text-2xl text-white/85 mb-8 max-w-3xl mx-auto">Premier golf course living in southwest Las Vegas. Discover Southern Highlands with{" "}

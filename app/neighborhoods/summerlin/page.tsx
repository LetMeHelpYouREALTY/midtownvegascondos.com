...
export const metadata: Metadata = withPageHeroMetadata(
  "/neighborhoods/summerlin",
  {
    ...
    description:
      "Find Summerlin homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy offers expert guidance in Las Vegas's premier master-planned community. Median price $625K. Call (702) 500-1980.",
    keywords: [
  ...
  return (
    <>
      ...
      <PageHero
        ...
        leadSectionKey="summerlinWhy"
        leadSectionHeading="Why Summerlin Is Las Vegas's Most Sought-After Community"
        ...
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16 bg-slate-900 text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <SectionPhoto
              ...
              heading="Summerlin Real Estate Market | January 2026"
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <div className="prose prose-lg max-w-none text-slate-700">
              ...
              <p>
                ...
                nuances of each village—from the parks and trail loops of The
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            <div className="bg-blue-50 border-l-4 border-blue-600 rounded-lg p-8">
              <blockquote className="text-lg text-slate-700 italic mb-4">
                ...
                serving this area since 2008, and I can tell you which villages
                have the shortest commute to Downtown Summerlin, the strongest
                recent comps, and where inventory turns fastest. That local
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            <SectionPhoto
              ...
              heading="Frequently Asked Questions About Summerlin Real Estate"
              className="mx-auto mb-8 max-w-4xl text-left"
            />
          ...
          <section className="text-center bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            <SectionPhoto
              imageKey="homeCta"
              heading="Ready to Find Your Summerlin Home?"

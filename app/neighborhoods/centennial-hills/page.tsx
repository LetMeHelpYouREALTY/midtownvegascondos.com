...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Centennial Hills is approximately 20-25 minutes from the Strip via US-95. The community offers easy freeway access, parks, and a suburban street pattern away from tourist corridors.",
      },
    },
    {
      "@type": "Question",
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <p className="text-slate-600">
                  ...
                  via US-95. The community offers easy freeway access, parks,
                  and a suburban street pattern away from tourist corridors.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                <h3 className="font-bold text-slate-900 mb-2">

...
export const metadata: Metadata = withPageHeroMetadata("/neighborhoods/mountains-edge", {
...
export default function MountainsEdgePage() {
  return (
    <>
      ...
      >
        <p className="text-xl md:text-2xl text-white/85 mb-8 max-w-3xl mx-auto">Affordable luxury in southwest Las Vegas. Find your Mountains Edge home with{" "}

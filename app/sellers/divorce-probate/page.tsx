...
export const metadata: Metadata = withPageHeroMetadata(
  "/sellers/divorce-probate",
  {
    ...
    description:
      "Sensitive real estate situations handled with discretion. Dr. Jan Duffy helps with divorce sales, probate, estate liquidation, and court-ordered sales. Call (702) 500-1980.",
    keywords: [
  ...
  return (
    <>
      ...
      <PageHero
        ...
        leadSectionKey="sellersSensitive"
        leadSectionHeading="Situations We Help Navigate"
      ...
      >
        ...
        >
          ...
          Confidential Consultation → (702) 500-1980
        </a>
      </PageHero>

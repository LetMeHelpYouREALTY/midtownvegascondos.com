  ...
  return (
    <>
      ...
      <PageHero
        ...
        leadSectionKey="sunCitySummerlinAbout"
        leadSectionHeading="About Sun City Summerlin"
        pagePath={PATH}
      ...
      >
        <p data-community-summary className="text-white/85 max-w-3xl mx-auto">
          Age-restricted active adult living in Summerlin. Call{" "}
          {agentInfo.phone} for available models, HOA dues, and golf proximity
          comps.
        </p>
      </PageHero>
        ...
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16 bg-slate-900 text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <SectionPhoto
              ...
              heading="Sun City Summerlin at a Glance"

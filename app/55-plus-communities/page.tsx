...
export const metadata: Metadata = withPageHeroMetadata("/55-plus-communities", {
  ...
  description:
    "Find your perfect 55+ community in Las Vegas. Sun City Summerlin, Sun City Aliante, Del Webb Lake Las Vegas, Heritage at Stonebridge, Solera, Trilogy. Dr. Jan Duffy specializes in active adult living. Call (702) 500-1980.",
  keywords: [
...
const communities = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Henderson location with championship golf and rec centers",
    ],
    description:
  ...
  return (
    <>
      ...
      <PageHero
        ...
        leadSectionKey="fiftyFiveWhy"
        leadSectionHeading="Why Active Adults Choose Las Vegas"

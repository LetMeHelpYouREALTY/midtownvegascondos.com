...
export const metadata: Metadata = withPageHeroMetadata(
  "/55-plus-communities/sun-city-anthem",
  {
    ...
    description:
      "Henderson's premier 55+ community. Sun City Anthem homes from $350K-$1.2M. 2 championship golf courses, stunning mountain views. Dr. Jan Duffy. Call (702) 500-1980.",
    keywords: [
  ...
  return (
    <>
      ...
      <PageHero
        ...
        leadSectionKey="sunCityAnthemAbout"
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-slate-700">
              ...
              <p>
                ...
                lifestyle to Henderson, with championship golf and a
                64,000-square-foot clubhouse. Built by Del Webb from 1998-2008,
                this 7,100+ home community offers mountain views, two golf
                courses, and resort-caliber rec amenities in Henderson.
              </p>
              <p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-700 mb-4">
                    ...
                    Anthem master plan. 55+ buyers compare HOA amenities,
                    elevation, and commute times rather than valley-wide
                    averages.
                  </p>
